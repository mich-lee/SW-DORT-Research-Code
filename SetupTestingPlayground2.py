...
intermediateSpacing = 1.6*um # inputSpacing / 2
...
d = 50*mm
thinLens1 = Thin_Lens(focal_length=d)
asmProp1 = ASM_Prop(init_distance=d, do_ffts_inplace=do_ffts_inplace)
asmProp2 = ASM_Prop(init_distance=d, do_ffts_inplace=do_ffts_inplace)#36*mm, do_ffts_inplace=do_ffts_inplace)
# asmProp2 = ASM_Prop(init_distance=(d - screenDist), do_ffts_inplace=do_ffts_inplace)#36*mm, do_ffts_inplace=do_ffts_inplace)
